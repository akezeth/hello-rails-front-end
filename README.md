...
**Hello-rails-front-end is a front end application that fetches a random greeting api from hello-rails back-end app.**
...
- This is hello-rails-back-end application <a href="https://github.com/akezeth/hello-rails-back-end">back-end Link</a>
...
```sh
  cd my-folder
  git clone https://github.com/akezeth/hello-rails-front-end.git
```
...
Acknowledgement goes to microverse for the knowledge given
